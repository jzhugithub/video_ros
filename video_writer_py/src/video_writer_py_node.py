...
class MyVideoWriter(object):
    ...
    def __init__(self):
        ...
        self.video_file_name = rospy.get_param('~video_file_name',
                                               '/home/zj/ros_workspace/src/video_writer_py/video/out.avi')
        # frame
        self.frame_num = 1
    ...
    def image_callback(self, msg):
        try:
            ...
            # self.src_3 = self.src_3[40:1040, 400:1400, :]
        ...
        if self.frame_num == 1:
            ...
            print('image_width: %s' % self.image_width)
            print('image_hight: %s' % self.image_hight)
        self.frame_num += 1
        # save and show video
...
if __name__ == '__main__':
    rospy.init_node('video_writer_py_node', anonymous=True)
