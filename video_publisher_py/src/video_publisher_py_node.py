...
class VideoPublisher(object):
    ...
    def __init__(self):
        ...
        # self.my_video.set(cv2.cv.CV_CAP_PROP_FRAME_HEIGHT, 1080.0)
        # self.my_video.set(cv2.cv.CV_CAP_PROP_FRAME_WIDTH, 1920.0)

        # self.my_video.set(cv2.cv.CV_CAP_PROP_CONTRAST, 0.4)
        # self.my_video.set(cv2.cv.CV_CAP_PROP_SATURATION, 0.4)
        # self.my_video.set(cv2.cv.CV_CAP_PROP_BRIGHTNESS, 0.4)
        # self.my_video.set(cv2.cv.CV_CAP_PROP_GAIN, 0.1)
        # self.my_video.set(cv2.cv.CV_CAP_PROP_HUE, 0.4)


        # self.my_video.set(cv2.cv.CV_CAP_PROP_CONTRAST, 0.5)
        # self.my_video.set(cv2.cv.CV_CAP_PROP_SATURATION, 0.5)
        # self.my_video.set(cv2.cv.CV_CAP_PROP_BRIGHTNESS, 0.5)
        # self.my_video.set(cv2.cv.CV_CAP_PROP_GAIN, 0.0)
        # self.my_video.set(cv2.cv.CV_CAP_PROP_HUE, 0.5)
        # self.my_video.set(cv2.cv.CV_CAP_PROP_EXPOSURE,10)
...
if __name__ == "__main__":
    rospy.init_node('video_publisher_py_node', anonymous=True)
